    ...
    gui.vlist(0, function()
        ...
        gui.table(5, 0.02, function()
            ...
            gui.vlist(0, function()
                ...
                std.var.new("custom_w", EAPI.VAR_S, tostring(EVAR.scr_w))
                std.var.new("custom_h", EAPI.VAR_S, tostring(EVAR.scr_h))
...
tgui.push_tab("Export entities", tgui.BAR_HORIZONTAL, tgui.BAR_EDIT, "icon_save", function()
    gui.vlist(0, function()
        ...
        std.var.new("newexportfilename", EAPI.VAR_S, "entities.json")
        std.var.persist_vars(was_persisting)
        gui.hlist(0, function()
            gui.label("filename: ")

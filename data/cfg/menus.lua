...
local main_id = tgui.push_tab("Main", tgui.BAR_VERTICAL, tgui.BAR_NORMAL, "icon_maps", function()
    gui.vlist(0, function()
        ...
        gui.label("engine. Start off by browsing the icons on the left", 0, 1, 1, 1, 1, function() gui.align(-1, 0) end)
    ...
    gui.vlist(0, function()
        ...
        gui.table(5, 0.02, function()
            ...
            gui.vlist(0, function()
                ...
                engine.new_var("custom_w", engine.VAR_S, tostring(scr_w))
                engine.new_var("custom_h", engine.VAR_S, tostring(scr_h))

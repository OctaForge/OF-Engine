...
M.new = function(tp, o, d, r, g, b, fade, size, gravity)
...
M.splash = function(tp, o, rad, num, r, g, b, fade, size, gravity, delay, un)
    _C.particle_splash(tp, o.x, o.y, o.z, rad, num, r, g, b, fade, size,
        gravity or 0, delay or 0, un)
end

M.trail = function(tp, o, d, r, g, b, fade, size, gravity)
    _C.particle_trail(tp, o.x, o.y, o.z, d.x, d.y, d.z, r, g, b, fade,
        size, gravity or 0)
end

M.text = function(tp, o, text, r, g, b, fade, size, gravity)
    _C.particle_text(tp, o.x, o.y, o.z, text, r, g, b, fade, size,
        gravity or 0)
end

M.icon_generic = function(tp, o, ix, iy, r, g, b, fade, size, gravity)
    _C.particle_icon_generic(tp, o.x, o.y, o.z, ix, iy, r, g, b, fade,
        size, gravity or 0)
end

M.icon = function(tp, o, itex, r, g, b, fade, size, gravity)
    _C.particle_icon(tp, o.x, o.y, o.z, itex, r, g, b, fade, size,
        gravity or 0)
end

M.meter = function(tp, o, val, r, g, b, fade, size)
    _C.particle_meter(tp, o.x, o.y, o.z, val, r, g, b, 0, 0, 0, fade, size)
end

M.meter_vs = function(tp, o, val, r, g, b, r2, g2, b2, fade, size)
...
M.fireball = function(tp, o, r, g, b, fade, size, maxsize)
...
M.shape = function(tp, o, rad, dir, num, r, g, b, fade, size, gravity, vel)
    _C.particle_shape(tp, o.x, o.y, o.z, rad, dir, num, r, g, b, fade,
        size, gravity or 0, vel or 200)
end

M.flame = function(tp, o, rad, h, r, g, b, fade, dens, scale, speed, grav)

...
--[[! Function: include
    ...
    libraries or anywhere from media/ (useful to include various assets,
    for example, library.include("texture.foo") runs a script
    "media/texture/foo/init.lua"). Returns the result of require()

...
public:
    ...
    virtual void rayCastClosest(vec &from, vec &to, float& hitDist, CLogicEntity *&hitEntity, CLogicEntity *ignore = NULL) = 0;
    ...
    virtual bool prepareRagdoll(CLogicEntity *self) { return true; };
};
